float mrqmin(x,y,sig,ndata,a,ma,lista,mfit,covar,alpha,chisq,funcs,alamda)
...
void (*funcs)();
{
	...
	float *fvector(),**matrix(),gaussj(),err;
	void mrqcof(),covsrt(),nrerror(),free_matrix(),free_fvector();
